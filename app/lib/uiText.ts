...
const en = {
  ...
  auth: {
    ...
    passwordChangeTitle: "Change password", passwordChangeDescription: "Enter your current password and choose a new password.", passwordChangeCurrent: "Current password", passwordChangeNew: "New password", passwordChangeConfirmation: "Confirm new password",
    passwordChangeCurrentRequired: "Enter your current password.", passwordChangeNewRequired: "Enter a new password.", passwordChangeConfirmationRequired: "Confirm your new password.", passwordChangeMismatch: "The passwords do not match.", passwordChangeCurrentIncorrect: "We couldn’t verify your current password.", passwordChangeValidationFailed: "Choose a different password that meets the password requirements.",
    passwordChangeUnavailableMethod: "Password change is not available for this sign-in method.", passwordChangeUnavailable: "Password change is temporarily unavailable. Please try again.", passwordChangeSessionRequired: "Sign in again before changing your password.", passwordChangeUnknown: "We couldn’t confirm whether your password was changed. Sign out, then try to sign in with the new password. If that does not work, use Password Recovery.", passwordChangeCleanupRequired: "Your password was changed, but secure sign-out could not be fully confirmed. Complete sign-out before signing in again.", passwordChangeUseRecovery: "Use Password Recovery", passwordChangeSubmit: "Change password", passwordChangeSubmitting: "Changing…", passwordChangeRetryCleanup: "Sign out and continue", passwordChangeCleaningUp: "Signing out…", passwordChangedNotice: "Your password has been changed. Sign in again with your new password.",
...
const nl = {
  ...
  auth: {
    ...
    passwordChangeTitle: "Wachtwoord wijzigen", passwordChangeDescription: "Vul je huidige wachtwoord in en kies een nieuw wachtwoord.", passwordChangeCurrent: "Huidig wachtwoord", passwordChangeNew: "Nieuw wachtwoord", passwordChangeConfirmation: "Bevestig nieuw wachtwoord",
    passwordChangeCurrentRequired: "Vul je huidige wachtwoord in.", passwordChangeNewRequired: "Vul een nieuw wachtwoord in.", passwordChangeConfirmationRequired: "Bevestig je nieuwe wachtwoord.", passwordChangeMismatch: "De wachtwoorden komen niet overeen.", passwordChangeCurrentIncorrect: "We konden je huidige wachtwoord niet verifiëren.", passwordChangeValidationFailed: "Kies een ander wachtwoord dat aan de wachtwoordvereisten voldoet.",
    passwordChangeUnavailableMethod: "Wachtwoord wijzigen is niet beschikbaar voor deze inlogmethode.", passwordChangeUnavailable: "Wachtwoord wijzigen is tijdelijk niet beschikbaar. Probeer het opnieuw.", passwordChangeSessionRequired: "Log opnieuw in voordat je je wachtwoord wijzigt.", passwordChangeUnknown: "We konden niet bevestigen of je wachtwoord is gewijzigd. Log uit en probeer daarna met het nieuwe wachtwoord in te loggen. Gebruik Wachtwoordherstel als dat niet lukt.", passwordChangeCleanupRequired: "Je wachtwoord is gewijzigd, maar veilig uitloggen kon niet volledig worden bevestigd. Rond het uitloggen af voordat je opnieuw inlogt.", passwordChangeUseRecovery: "Wachtwoordherstel gebruiken", passwordChangeSubmit: "Wachtwoord wijzigen", passwordChangeSubmitting: "Wijzigen…", passwordChangeRetryCleanup: "Uitloggen en doorgaan", passwordChangeCleaningUp: "Uitloggen…", passwordChangedNotice: "Je wachtwoord is gewijzigd. Log opnieuw in met je nieuwe wachtwoord.",
...
const fr = {
  ...
  auth: {
    ...
    passwordChangeTitle: "Modifier le mot de passe", passwordChangeDescription: "Saisissez votre mot de passe actuel et choisissez-en un nouveau.", passwordChangeCurrent: "Mot de passe actuel", passwordChangeNew: "Nouveau mot de passe", passwordChangeConfirmation: "Confirmer le nouveau mot de passe",
    passwordChangeCurrentRequired: "Saisissez votre mot de passe actuel.", passwordChangeNewRequired: "Saisissez un nouveau mot de passe.", passwordChangeConfirmationRequired: "Confirmez votre nouveau mot de passe.", passwordChangeMismatch: "Les mots de passe ne correspondent pas.", passwordChangeCurrentIncorrect: "Nous n’avons pas pu vérifier votre mot de passe actuel.", passwordChangeValidationFailed: "Choisissez un autre mot de passe conforme aux exigences.",
    passwordChangeUnavailableMethod: "La modification du mot de passe n’est pas disponible pour cette méthode de connexion.", passwordChangeUnavailable: "La modification du mot de passe est temporairement indisponible. Veuillez réessayer.", passwordChangeSessionRequired: "Reconnectez-vous avant de modifier votre mot de passe.", passwordChangeUnknown: "Nous n’avons pas pu confirmer si votre mot de passe a été modifié. Déconnectez-vous, puis essayez de vous connecter avec le nouveau mot de passe. En cas d’échec, utilisez la récupération du mot de passe.", passwordChangeCleanupRequired: "Votre mot de passe a été modifié, mais la déconnexion sécurisée n’a pas pu être entièrement confirmée. Terminez la déconnexion avant de vous reconnecter.", passwordChangeUseRecovery: "Utiliser la récupération du mot de passe", passwordChangeSubmit: "Modifier le mot de passe", passwordChangeSubmitting: "Modification…", passwordChangeRetryCleanup: "Se déconnecter et continuer", passwordChangeCleaningUp: "Déconnexion…", passwordChangedNotice: "Votre mot de passe a été modifié. Reconnectez-vous avec votre nouveau mot de passe.",
...
const de = {
  ...
  auth: {
    ...
    passwordChangeTitle: "Passwort ändern", passwordChangeDescription: "Gib dein aktuelles Passwort ein und wähle ein neues Passwort.", passwordChangeCurrent: "Aktuelles Passwort", passwordChangeNew: "Neues Passwort", passwordChangeConfirmation: "Neues Passwort bestätigen",
    passwordChangeCurrentRequired: "Gib dein aktuelles Passwort ein.", passwordChangeNewRequired: "Gib ein neues Passwort ein.", passwordChangeConfirmationRequired: "Bestätige dein neues Passwort.", passwordChangeMismatch: "Die Passwörter stimmen nicht überein.", passwordChangeCurrentIncorrect: "Dein aktuelles Passwort konnte nicht bestätigt werden.", passwordChangeValidationFailed: "Wähle ein anderes Passwort, das die Passwortanforderungen erfüllt.",
    passwordChangeUnavailableMethod: "Das Ändern des Passworts ist für diese Anmeldemethode nicht verfügbar.", passwordChangeUnavailable: "Das Ändern des Passworts ist vorübergehend nicht verfügbar. Bitte versuche es erneut.", passwordChangeSessionRequired: "Melde dich erneut an, bevor du dein Passwort änderst.", passwordChangeUnknown: "Wir konnten nicht bestätigen, ob dein Passwort geändert wurde. Melde dich ab und versuche dann, dich mit dem neuen Passwort anzumelden. Verwende die Passwortwiederherstellung, falls dies nicht funktioniert.", passwordChangeCleanupRequired: "Dein Passwort wurde geändert, aber die sichere Abmeldung konnte nicht vollständig bestätigt werden. Schließe die Abmeldung ab, bevor du dich erneut anmeldest.", passwordChangeUseRecovery: "Passwortwiederherstellung verwenden", passwordChangeSubmit: "Passwort ändern", passwordChangeSubmitting: "Wird geändert…", passwordChangeRetryCleanup: "Abmelden und fortfahren", passwordChangeCleaningUp: "Abmeldung…", passwordChangedNotice: "Dein Passwort wurde geändert. Melde dich erneut mit deinem neuen Passwort an.",
...
const pl = {
  ...
  auth: {
    ...
    passwordChangeTitle: "Zmień hasło", passwordChangeDescription: "Wpisz obecne hasło i wybierz nowe hasło.", passwordChangeCurrent: "Obecne hasło", passwordChangeNew: "Nowe hasło", passwordChangeConfirmation: "Potwierdź nowe hasło",
    passwordChangeCurrentRequired: "Wpisz obecne hasło.", passwordChangeNewRequired: "Wpisz nowe hasło.", passwordChangeConfirmationRequired: "Potwierdź nowe hasło.", passwordChangeMismatch: "Hasła nie są zgodne.", passwordChangeCurrentIncorrect: "Nie udało się zweryfikować obecnego hasła.", passwordChangeValidationFailed: "Wybierz inne hasło spełniające wymagania.",
    passwordChangeUnavailableMethod: "Zmiana hasła nie jest dostępna dla tej metody logowania.", passwordChangeUnavailable: "Zmiana hasła jest chwilowo niedostępna. Spróbuj ponownie.", passwordChangeSessionRequired: "Zaloguj się ponownie przed zmianą hasła.", passwordChangeUnknown: "Nie udało się potwierdzić, czy hasło zostało zmienione. Wyloguj się, a następnie spróbuj zalogować się nowym hasłem. Jeśli to nie zadziała, użyj odzyskiwania hasła.", passwordChangeCleanupRequired: "Hasło zostało zmienione, ale nie udało się w pełni potwierdzić bezpiecznego wylogowania. Zakończ wylogowanie przed ponownym zalogowaniem.", passwordChangeUseRecovery: "Użyj odzyskiwania hasła", passwordChangeSubmit: "Zmień hasło", passwordChangeSubmitting: "Zmienianie…", passwordChangeRetryCleanup: "Wyloguj i kontynuuj", passwordChangeCleaningUp: "Wylogowywanie…", passwordChangedNotice: "Twoje hasło zostało zmienione. Zaloguj się ponownie przy użyciu nowego hasła.",
