...
const en = {
  ...
  settings: {
    ...
    emailChange: {
      ...
      description: "Confirm your current password before requesting a new email address.",
      currentEmail: "Confirmed email address",
      currentPassword: "Current password",
      ...
      unchangedEmail: "Enter an email address different from your current address.",
      reauthenticationFailed: "Your current password could not be confirmed.",
      failure: "Your email change could not be requested. Please try again.",
      pending: "Check both your current and new inbox. Your email address changes only after both confirmations are complete.",
      synchronizationPending: "Your confirmed email is being synchronized with your account services.",
      synchronizationReview: "Your email changed, but synchronization needs review. Please contact support before changing it again.",
      loading: "Loading email status…",
      statusUnavailable: "Your email-change status could not be verified. Try again before requesting a change.",
      requestBlocked: "A new email change cannot be requested right now. Refresh the status and try again later.",
...
const nl = {
  ...
  settings: {
    ...
    emailChange: {
      ...
      description: "Bevestig je huidige wachtwoord voordat je een nieuw e-mailadres aanvraagt.",
      currentEmail: "Bevestigd e-mailadres",
      currentPassword: "Huidig wachtwoord",
      newEmail: "Nieuw e-mailadres",
      submit: "E-mailwijziging aanvragen",
      saving: "Aanvragen…",
      currentPasswordRequired: "Vul je huidige wachtwoord in.",
      invalidEmail: "Vul een geldig e-mailadres in.",
      unchangedEmail: "Vul een ander e-mailadres in dan je huidige adres.",
      reauthenticationFailed: "Je huidige wachtwoord kon niet worden bevestigd.",
      failure: "Je e-mailwijziging kon niet worden aangevraagd. Probeer het opnieuw.",
      pending: "Controleer je huidige én nieuwe inbox. Je e-mailadres wijzigt pas nadat beide bevestigingen zijn voltooid.",
      synchronizationPending: "Je bevestigde e-mailadres wordt gesynchroniseerd met je accountdiensten.",
      synchronizationReview: "Je e-mailadres is gewijzigd, maar de synchronisatie moet worden gecontroleerd. Neem contact op met support voordat je het opnieuw wijzigt.",
      loading: "E-mailstatus laden…",
      statusUnavailable: "De status van je e-mailwijziging kon niet worden gecontroleerd. Probeer het opnieuw voordat je een wijziging aanvraagt.",
      requestBlocked: "Je kunt nu geen nieuwe e-mailwijziging aanvragen. Vernieuw de status en probeer het later opnieuw.",
      retryStatus: "Status opnieuw controleren",
    },
  },
...
const fr = {
  ...
  settings: {
    ...
    emailChange: {
      ...
      description: "Confirmez votre mot de passe actuel avant de demander une nouvelle adresse e-mail.",
      currentEmail: "Adresse e-mail confirmée",
      currentPassword: "Mot de passe actuel",
      newEmail: "Nouvelle adresse e-mail",
      submit: "Demander la modification",
      saving: "Demande en cours…",
      currentPasswordRequired: "Saisissez votre mot de passe actuel.",
      invalidEmail: "Saisissez une adresse e-mail valide.",
      unchangedEmail: "Saisissez une adresse e-mail différente de votre adresse actuelle.",
      reauthenticationFailed: "Votre mot de passe actuel n’a pas pu être confirmé.",
      failure: "La modification de votre adresse e-mail n’a pas pu être demandée. Réessayez.",
      pending: "Consultez votre boîte actuelle et la nouvelle. Votre adresse ne changera qu’après les deux confirmations.",
      synchronizationPending: "Votre adresse e-mail confirmée est en cours de synchronisation avec les services de votre compte.",
      synchronizationReview: "Votre adresse e-mail a changé, mais la synchronisation doit être vérifiée. Contactez l’assistance avant de la modifier à nouveau.",
      loading: "Chargement du statut de l’adresse e-mail…",
      statusUnavailable: "Le statut de votre modification d’adresse e-mail n’a pas pu être vérifié. Réessayez avant de demander une modification.",
      requestBlocked: "Une nouvelle modification d’adresse e-mail ne peut pas être demandée pour le moment. Actualisez le statut et réessayez plus tard.",
      retryStatus: "Vérifier à nouveau le statut",
    },
  },
...
const de = {
  ...
  settings: {
    ...
    emailChange: {
      ...
      description: "Bestätige dein aktuelles Passwort, bevor du eine neue E-Mail-Adresse anforderst.",
      currentEmail: "Bestätigte E-Mail-Adresse",
      currentPassword: "Aktuelles Passwort",
      newEmail: "Neue E-Mail-Adresse",
      submit: "E-Mail-Änderung anfordern",
      saving: "Wird angefordert…",
      currentPasswordRequired: "Gib dein aktuelles Passwort ein.",
      invalidEmail: "Gib eine gültige E-Mail-Adresse ein.",
      unchangedEmail: "Gib eine andere E-Mail-Adresse als deine aktuelle Adresse ein.",
      reauthenticationFailed: "Dein aktuelles Passwort konnte nicht bestätigt werden.",
      failure: "Die Änderung deiner E-Mail-Adresse konnte nicht angefordert werden. Versuche es erneut.",
      pending: "Prüfe dein aktuelles und dein neues Postfach. Deine E-Mail-Adresse ändert sich erst nach beiden Bestätigungen.",
      synchronizationPending: "Deine bestätigte E-Mail-Adresse wird mit deinen Kontodiensten synchronisiert.",
      synchronizationReview: "Deine E-Mail-Adresse wurde geändert, aber die Synchronisierung muss geprüft werden. Kontaktiere den Support, bevor du sie erneut änderst.",
      loading: "E-Mail-Status wird geladen…",
      statusUnavailable: "Der Status deiner E-Mail-Änderung konnte nicht überprüft werden. Versuche es erneut, bevor du eine Änderung anforderst.",
      requestBlocked: "Eine neue E-Mail-Änderung kann derzeit nicht angefordert werden. Aktualisiere den Status und versuche es später erneut.",
      retryStatus: "Status erneut prüfen",
    },
  },
...
const pl = {
  ...
  settings: {
    ...
    emailChange: {
      ...
      description: "Potwierdź obecne hasło przed zgłoszeniem nowego adresu e-mail.",
      currentEmail: "Potwierdzony adres e-mail",
      currentPassword: "Obecne hasło",
      newEmail: "Nowy adres e-mail",
      submit: "Zgłoś zmianę adresu",
      saving: "Wysyłanie zgłoszenia…",
      currentPasswordRequired: "Wpisz obecne hasło.",
      invalidEmail: "Wpisz prawidłowy adres e-mail.",
      unchangedEmail: "Wpisz adres e-mail inny niż obecny.",
      reauthenticationFailed: "Nie udało się potwierdzić obecnego hasła.",
      failure: "Nie udało się zgłosić zmiany adresu e-mail. Spróbuj ponownie.",
      pending: "Sprawdź obecną i nową skrzynkę. Adres e-mail zmieni się dopiero po obu potwierdzeniach.",
      synchronizationPending: "Potwierdzony adres e-mail jest synchronizowany z usługami konta.",
      synchronizationReview: "Adres e-mail został zmieniony, ale synchronizacja wymaga sprawdzenia. Skontaktuj się z pomocą przed kolejną zmianą.",
      loading: "Ładowanie statusu adresu e-mail…",
      statusUnavailable: "Nie udało się zweryfikować statusu zmiany adresu e-mail. Spróbuj ponownie przed zgłoszeniem zmiany.",
      requestBlocked: "Nie można teraz zgłosić nowej zmiany adresu e-mail. Odśwież status i spróbuj ponownie później.",
      retryStatus: "Sprawdź status ponownie",
    },
  },
